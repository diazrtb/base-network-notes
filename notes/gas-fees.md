...
Base uses gas fees to process transactions on the network. Compared to Ethereum mainnet, transaction costs are generally lower.
...
Lower transaction fees make Base suitable for applications that require frequent onchain interactions.
